#+PROPERTY: header-args:emacs-lisp :tangle (concat temporary-file-directory "風雨.el") :lexical t
#+title: 風雨
  ...
  (defun nasy/-set-font (&rest _)
    ...
    (setup nasy-font
      ...
      (:opt*
       ...
       ,*font-main-family*   "Maple Mono NF"  ;; "Monaspace Radon Var"
      ...
      (:opts*
       ...
       ((*font-cjk-scale*
         ...
         ,*font-cjk-4-scale*
         ,*font-cjk-5-scale*)
        . 1.25)  ;; (maple-font 15 1.25) (monolisa 14 1.3)
       ((*font-symbol-weight*
         ;; *font-cjk-4-weight*
         ;; *font-cjk-5-weight*
