#+PROPERTY: header-args:elisp :tangle (concat temporary-file-directory "麐之趾.el") :lexical t
#+title: 麐之趾
...
#+begin_src elisp
  ...
  (leaf org-agenda
    ...
    (;; org-agnda
     ...
     (org-agenda-files            . `(,(locate-user-emacs-file "萚兮/standard-agenda.org")))
  ...
  (leaf org-export
    ...
    (;; Pandoc
     ((org-pandoc-options-for-context
      ...
      . '((template . "~/.emacs.d/extra/nasy-context.tex")))))
...
#+begin_src elisp :tangle (concat temporary-file-directory "org-prettify-source-block.el")
...
#+begin_src elisp
  (n/leaf python-isort
    ...
    :after reformatter
    :init
    (sup `(python-isort :local-repo ,(locate-user-emacs-file "木瓜/nasy/python-isort"))))
#+end_src
