#+PROPERTY: header-args:elisp :tangle (concat temporary-file-directory "小曐.el") :lexical t
#+title: 小曐
...
This library lets elisp authors easily define an idiomatic command to reformat
