...
#+begin_src elisp
  ...
  (defcustom *font-symbol* "Symbola"
     "The symbol font.  After change it, run `M-x nasy/set-font' to see the effect."
     :group 'nasy
     :type 'string)

  (defcustom *font-size-symbol* 15.0
   "The symbol font.  After change it, run `M-x nasy/set-font' to see the effect."
   :group 'nasy
   :type 'float)
  ...
  (defcustom *font-weight-cjk* 'normal
   "The cjk font.  After change it, run `M-x nasy/set-font' to see the effect."
   :group 'nasy
   :type 'symbol)

  (defcustom *font-weight-cjk-2* 'black
   "The cjk font.  After change it, run `M-x nasy/set-font' to see the effect."
   :group 'nasy
   :type 'symbol)

  (defcustom *font-modeline* "Recursive Mono Casual Static"
   "The modenline font.  After change it, run `M-x nasy/set-font' to see the effect."
   :group 'nasy
   :type 'symbol)
