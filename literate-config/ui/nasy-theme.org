...
#+begin_src elisp
  ...
  (let* ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     `(error        ((,class (:background ,n-red :foreground ,n-素 :weight bold))))
     `(escape-glyph ((,class (:foreground ,n-茶))))
     `(fringe       ((,class (:background ,n/霜黛 :foreground ,n/黛霜))))
     `(header-line  ((,class (:background ,n/霜黛
     ...
     `(link-visited ((,class (:foreground ,n-red-l :underline t))))
     `(secondary-selection
       ((,class (:background ,n-鱼肚))))
     `(success      ((,class (:background ,n-green :foreground ,n-黛 :weight bold))))
     `(variable-pitch
       ((,class (:font ,(font-spec :name "Rec Mono Nasy"
                                   :weight 'normal
                                   :slant 'normal)))))
     `(warning      ((,class (:background ,n-鸭黄 :foreground ,n-黛 :weight bold))))


     ;; company
     `(company-tooltip           ((,class (:background ,n/霜黛 :foreground ,n/黛霜))))
     `(company-tooltip-selection ((,class (:background ,n/黛霜 :foreground ,n/霜黛))))
     ...
     ;; mode line
     `(mode-line ((,class (:background ,n/霜黛))))
