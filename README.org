...
#+HTML_HEAD: <style>pre.src {text-shadow: 2px 2px 15px; box-shadow: 1px 1px 5px #7a378b; color: #39375b; background-color: #ffffd2; font-family: Menlo, Monaco, Console, monospace;}</style>
