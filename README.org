...
#+begin_src elisp
  (use-package pretty-mode
    :demand t
    :straight t
    :hook (((prog-mode text-mode org-mode) . turn-on-pretty-mode)
           ...
           ((prog-mode
             ...
             org-mode) . (lambda () (mapc (lambda (pair) (push pair prettify-symbols-alist))
                                     '(;; Global
                                       ...
                                       ("{-"   . (?\s (Br . Bl) ?\s (Br . Bl) #Xe108))
                                       ("-}"   . (?\s (Br . Bl) ?\s (Br . Bl) #Xe110))
                                       ("\\"   . (?\s (Br . Bl) #Xe106))
                                       ...
                                       ;; Arrows
                                       ;; Direct
                                       ("->"  . (?\s (Br . Bl) ?\s (Br . Bl) #Xe114))
                                       ("=>"  . (?\s (Br . Bl) ?\s (Br . Bl) #Xe13f))
...
#+begin_src elisp
  (use-package lsp-ui
    ...
    :bind (:map lsp-ui-mode-map
                ...
                ("C-c u"   . lsp-ui-imenu)
                ("C-c C-r" . lsp-ui-sideline-apply-code-actions))
...
#+begin_src elisp
  (use-package python
    ...
    :hook ((python-mode . lsp)
           ...
           (hack-local-variables . (lambda () (push 'company-files
                                               company-backends))))
